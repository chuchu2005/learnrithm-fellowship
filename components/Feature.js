...
export default function Feature() {
    return (
        <section id="what-youll-build" style={{ scrollMarginTop: "6rem" }} className="pt-15 pt-md-20 pt-lg-30 position-relative">
                ...
                <div className="row">
                    <div className="col-lg-8 col-xxl-6 mx-auto text-center" data-ss-reveal-group="" data-y="50">
                        ...
                        <h2 className="ss-text-reveal-blur mb-0">
                            Real AI Apps You Will Build With Your Own Hands
                        </h2>
                    </div>
                </div>
