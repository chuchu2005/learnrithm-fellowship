...
const reviews = [
    {
        ...
        text: "I was getting C's in math until I found Learnrithm. The AI tutor explains things in a way I actually understand. Last month I got an A on my calculus test!"
    },
    {
        id: 2,
        ...
        text: "Learnrithm helped me prepare for my finals in just 2 weeks. The study plans kept me organized and the practice tests were exactly like the real thing."
    },
    {
        id: 3,
        ...
        text: "The AI question generator is amazing for anatomy practice. I can create unlimited quizzes on any topic. My grades went from B+ to straight A's."
    },
    {
        id: 4,
        ...
        role: "GCSE Student",
        text: "I used to hate revising for hours. Now I spend half the time and remember twice as much. Learnrithm makes studying actually feel fun."
    },
    {
        id: 5,
        ...
        name: "Priya Patel",
        role: "Law Student",
        text: "The AI breaks down complex legal concepts into simple explanations. It's like having a study partner available 24/7. Highly recommend!"
    }
];
                ...
                <div className="row">
                    <div className="col-lg-8 col-xxl-6 mx-auto text-center" data-ss-reveal-group="" data-y="50">
                        ...
                        <h2 className="ss-text-reveal-blur mb-0">
                            See how students got their A,\nLet Learnrithm lead the way!
                        </h2>
                    </div>
                </div>
            </div>
